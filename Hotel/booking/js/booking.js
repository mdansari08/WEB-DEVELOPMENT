	...
	$.fn.bookingForm=function(options){
		return this.each(function(){
			...
			object = {
				...
				ownerEmail:'sam.wap7@outlook.com', // destination e-mail, message will be send on this e-mail
				...
				successMessage: "Your booking has been confirmed! We'll be in touch soon!", // success message
				// private fields
				form: null,
				fields: [],
